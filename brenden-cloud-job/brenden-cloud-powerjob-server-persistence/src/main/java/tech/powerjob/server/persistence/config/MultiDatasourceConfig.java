 ...
 */
@Configuration
@EnableConfigurationProperties(OmsRemoteDatasourceProperties.class)
...
//    }
    @Primary
    @Bean("omsRemoteDatasource")
    public DataSource initOmsCoreDatasource(OmsRemoteDatasourceProperties omsRemoteDatasourceProperties) {
        return DataSourceBuilder.create()
                .driverClassName(omsRemoteDatasourceProperties.getDriverClassName())
                .url(omsRemoteDatasourceProperties.getJdbcUrl())
                .username(omsRemoteDatasourceProperties.getUsername())
                .password(omsRemoteDatasourceProperties.getPassword())
                .build();
    }
